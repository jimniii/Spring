...
class User1RepositoryTest {
    ...
    void findUser1BYId() {
        ...
        User1 user1 = user1Repository.findUser1ByUsid("a101");
    ...
    @Test
    void findUser1ByUsidAndName() {
    }

    @Test
    void findUser1ByUsidOrName() {
    }
    ...
    @Test
    void countUser1EntityByUsid() {
    }

    @Test
    void countUser1EntityByName() {
    }
